...
const Profile = () => {
  ...
  return (
    <div className="mx-auto my-20 max-w-4xl px-4 bg-gray-100 rounded-2xl dark:bg-black p-5">
      <h1 className="text-center text-2xl md:text-left font-bold">
        MY PROFILE
      </h1>
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 my-5">
        <div className="flex flex-col items-center">
          <Avatar className="h-24 w-24 md:h-44 md:w-44 border-e-8 border-blue-200 mt-2 object-cover">
            <AvatarImage
              src={
                user?.photoUrl ||
        ...
        <div className="ml-5 mt-4">
          <div className="mb-2">
            <h1 className="font-semibold text-gray-900 dark:text-gray-100 text-lg ">
              Name:
              <span className="text-gray-800 dark:text-gray-300 font-normal ml-2 text-md">
                {user?.name}
              </span>
            </h1>
          </div>
          <div className="mb-2">
            <h1 className="font-semibold text-gray-900 dark:text-gray-100 text-xl">
              Email:
              <span className="text-gray-800 dark:text-gray-300 font-normal ml-2 text-lg">
                {user?.email}
              </span>
            </h1>
          </div>
